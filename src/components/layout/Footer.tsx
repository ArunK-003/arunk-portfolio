        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              Creative UI/UX Designer focused on building visually appealing and user-friendly digital experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              { [ "UI/UX Design", "Prototyping", "User Research", "Design Systems", "Web Development", "Photo & Video Editing" ].map((item) => (
                <li key={ item }>
                  <Link
                    href="#"
                    className="text-gray-600 hover:text-blue-400 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Mail className="h-4 w-4 mr-2" /> ksarun459@gmail.com
              </li>
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Github className="h-4 w-4 mr-2" /> github.com/ArunK-003
              </li>
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Linkedin className="h-4 w-4 mr-2" /> linkedin.com/in/arun-k19
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              © { new Date().getFullYear() } Arun K. All rights reserved.
            </p>
