...
const contactDetails = [
  {
    name: "Email",
    value: "ksarun459@gmail.com",
    href: "mailto:ksarun459@gmail.com",
    icon: FaEnvelope,
  },
  {
    name: "LinkedIn",
    value: "linkedin.com/in/arun-k19/",
    href: "https://www.linkedin.com/in/arun-k19/",
    icon: FaLinkedin,
  },
  {
    name: "GitHub",   
    value: "github.com/ArunK-003/",
    href: "https://github.com/ArunK-003/",
    icon: FaGithub,
  },
];
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-start">
          <motion.div
            ...
            className="group bg-zinc-800/70 backdrop-blur-md border border-zinc-700/50 rounded-xl p-6 sm:p-8 shadow-xl mt-10 hover:shadow-[0_0_25px_2px_rgba(56,189,248,0.3)] transition-all duration-300 hover:scale-[1.02]"
          >
            <h3 className="text-2xl font-semibold text-white mb-6">Contact Information</h3>
            <ul className="space-y-5 mb-8">
            {contactDetails.map((item) => (
            <li key={item.name} className="flex items-start gap-4 group">
            <item.icon className="text-blue-400 group-hover:text-blue-500 w-5 h-5 mt-1 flex-shrink-0 transition-colors duration-300" />
            <div>
        ...
        >
          ...
          <div className="group bg-zinc-800/70 backdrop-blur-md border border-zinc-700/50 rounded-xl p-6 sm:p-8 shadow-xl mt-10 hover:shadow-[0_0_25px_2px_rgba(236,72,153,0.3)] transition-all duration-300 hover:scale-[1.02]">
