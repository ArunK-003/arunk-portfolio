...
const AboutMeSection = () => {
  ...
  return (
    <section id="about" className="py-28 sm:py-32 relative bg-gray-950 text-white overflow-hidden">
      {/* Background Blobs */}
...
>
  <div className="relative w-full max-w-[560px] h-[560px] rounded-xl overflow-hidden border border-zinc-800 shadow-2xl group mx-auto">
    <Image
      src={profileImageUrl}
      alt="Arun K - UI UX Designer and Frontend Developer"
      fill
      ...
      <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 py-1.5 rounded-md w-fit">
        ...
        <span className="text-xs sm:text-sm font-medium text-gray-100">Available for work</span>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
          >
            <GlassmorphicCard className="transition-all hover:shadow-[0_0_25px_3px_rgba(34,211,238,0.3)] duration-500">
              <p className="text-lg text-zinc-300 leading-relaxed lg:text-justify">
                Hello! I&apos;m <strong className="text-teal-400">Arun K</strong>, a final-year Software Engineering student at K. S. Rangasamy College of Technology. My academic path has sharpened my skills in both design and development, but my true passion lies in crafting user-first interfaces.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mt-8 pt-6 border-t border-zinc-700/50">
                <div>
                  ...
                  <div className="font-medium text-zinc-200">Arun K</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="font-medium text-zinc-200">Tamil Nadu, India</div>
                </div>
                <div>
