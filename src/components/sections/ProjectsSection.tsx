          ...
          <AnimatePresence>
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute -inset-0.5 bg-gradient-to-r from-teal-500 via-purple-500 to-blue-500 rounded-xl blur-xl opacity-60 group-hover:opacity-100 transition duration-500 group-hover:scale-105 z-0"></div>
